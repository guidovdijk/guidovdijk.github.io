...
// TODO: Ensure gradient is ahead of the white divider
// TODO: Start the animation on a larger start offset
// TODO: End the animation on a larger end offset
...
export const Divider: React.FC = () => {
  ...
  const rotateGradient = useTransform(
    scrollYProgress,
    [
      0,
      0.75,
  ...
  return (
    <div ref={ref} className="flex items-center justify-center relative">
      <div className="absolute flex h-full w-full items-center justify-center">
        ...
        <DividerSvgGradient
          className="rotate-[var(--rotate)]"
          style={{ '--rotate': rotateGradient } as any}
        />
      </div>
