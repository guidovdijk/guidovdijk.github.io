...
export const Card: React.FC<ICardProps> = ({
  ...
  <article {...props} className={`rounded transition-all border-b border-black-200 lg:pl-14 lg:pr-10 px-4 lg:pb-0 pb-4 group/card flex flex-col lg:flex-row lg:items-center ${className}`}>
    <NLink className="flex flex-col lg:flex-row flex-grow transition-all lg:items-center lg:h-[118px] lg:group-hover/card:h-[148px]" href={href}>
      <div className="lg:flex shrink-0 gap-x-4 mb-6 lg:mb-0">
        <span className="xl:group-hover/card:mr-14 lg:group-hover/card:mr-4 font-normal lg:group-hover/card:text-heading-l">
          {`0${index}`}
        </span>
    ...
    <div className="h-full lg:h-[118px]">
      <div className="bg-black-200 lg:group-hover/card:bg-white-200/20 md:mx-10 w-[0.5px] h-full" />
    </div>
    {
      url
        ? (
